...
تشخیص اینکه آرایۀ $\large{A[1, ..., n]}$، یک Minheap یا Maxheap است، از مرتبۀ $\boldsymbol{\mathcal{O}(n)}$ است. زیرا باید عناصر داخلی $\large{A[1]}$ تا $\large{A\left[\lfloor\frac{n}{2}\rfloor\right]}$ را با فرزندان‌شان مقایسه کنیم.
