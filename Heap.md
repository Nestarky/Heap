...
**سوال ۱۵)** کدام‌یک از اعمال زیر را نمی‌توان در یک Maxheap با $\large{n}$ عنصر در مرتبۀ $\large{\mathcal{O}(\log n)}$ انجام داد؟ 18
...
## ✍️ تهیه‌کنندگان
- گردآوری مطالب: **زهرا چرخ‌کار**
- پیاده‌سازی کدها و مطالب تکمیلی: **مهدی ارجمندی**
- تدوین نهایی و قالب‌بندی Markdown: **نصیر غفاری**

</div>
## 👥 گروه تهیه

- **خانم X** — جمع‌آوری و تنظیم مطالب  
- **آقای Y** — پیاده‌سازی کدها و تکمیل محتوا  
- **[نام شما]** — آماده‌سازی نسخه Markdown
